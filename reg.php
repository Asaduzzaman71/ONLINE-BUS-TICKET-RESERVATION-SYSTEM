            ...
            <div class="col-sm-4">
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="noftckt" placeholder="" required>
                    </div>
...
<?php
    ...
    $sql = "INSERT INTO registration_table(doj,dor,bt,oc,dc,nos,cpn,mbn,email,adress,diff,noftckt) VALUES ('$datj','$dater','$typeb','$orcity','$destc','$nseat','$contn','$mobile','$email','$addr','$date','$noftckt')";
