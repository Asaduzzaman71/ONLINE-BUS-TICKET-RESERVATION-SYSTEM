...
<body>
    ...
    <div class="jumbotron jumbotron-fluid ag">
        ...
        <div class="container-fluid">
            <p class="microsoft marquee" style="margin-top: 75px; ">If you have an account in tradition bd.com then you will get an offer. If you want to get an offer please <a href="login.php"> Login </a>your account.If you dont have an account please create<a href="signup.php"> Sign-Up </a> a new account </p>
            </div>
    </div>
    ...
    <div class="container bg">
        <h1 style="color:#fff;">POPULAR BUS ROUTES</h1>
